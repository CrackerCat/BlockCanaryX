...
function convertFlameTextToFlameStacks(flameGraphText, reverseFrame) {
    console.log('start convert flame'+flameGraphText)
  ...
  console.log('flameStackList is'+flameStackList)
...
function convertFlameStackListToNodeTree(flameStacks) {
  ...
  if (root.children != null && root.children.length === 1) {
    console.log('return node -> 1 ',JSON.stringify(root.children[0]))
    return root.children[0]
  }
  console.log('return node -> 2',JSON.stringify(root))
  return root
}
