...
function convertFlameTextToFlameStacks(flameGraphText, order) {
...
function convertFlameGraphTextToNodeTree(flameGraphText){
    var flameStacks = convertFlameTextToFlameStacks(flameGraphText)
